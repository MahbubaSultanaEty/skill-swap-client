    ...
    <div style={{ background: "#f8faf8", minHeight: "100vh" }} className="px-4 py-12">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight" style={{ color: "#14532d" }}>
            Apply for this Task
          </h1>
            ...
            <div className="sticky top-20 rounded-2xl border p-6" style={{ background: "#fff", borderColor: "#dcfce7" }}>
              ...
              <div className="space-y-3 border-t pt-4" style={{ borderColor: "#dcfce7" }}>
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="font-semibold" style={{ color: "#14532d" }}>${task?.budget}</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <div className="flex size-7 items-center justify-center rounded-lg" style={{ background: "#dcfce7" }}>
                  ...
                  <span className="font-semibold" style={{ color: "#14532d" }}>
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="font-semibold" style={{ color: "#14532d" }}>{task?.clientName}</span>
                </div>
              </div>
            </div>
          </div>
